...
August 2020--Present
\begin{itemize}
\item Currently working on the Capital Program Resource Model (CPRM)
  project at C2SMART:
  \begin{center}
    \url{https://c2smart.engineering.nyu.edu/Capital-Program-Resource-Model}
  \end{center}
\item Working towards development of a means for assessing the
  ...
  project outcomes.
\item One of the major goals of the project is to help NYSDOT improve
  project outcomes through effective allocation of resources (staff,
  consultants, etc.) to projects throughout the state.
\item \textbf{Skills used:} R, data processing, statistics, network analysis
\end{itemize}
